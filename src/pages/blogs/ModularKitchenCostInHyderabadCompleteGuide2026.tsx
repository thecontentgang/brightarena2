...
export default function ModularKitchenCostInHyderabadCompleteGuide2026() {
  ...
  return (
    <>
      ...
      <main className="bg-[#f7f4ee] text-[#4a1c13] w-full min-h-screen antialiased selection:bg-[#ff7043] selection:text-white pb-24">
        ...
        {/* ── NEXT POST CTA ── */}
        <NextPostCTA title={"The Art of Biophilic Design: Bringing Nature Indoors"} slug={"art-of-biophilic-design"} />
      </main>
    </>
  );
}
