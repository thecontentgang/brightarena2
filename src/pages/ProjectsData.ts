...
export const projectsData: Project[] = [
  {
    ...
    heroImage: "/projectsImg/rajapushpa/RP-img1.jpg",
    gallery: Array.from({ length: 60 }, (_, i) => `/projectsImg/rajapushpa/RP-img${i + 1}.jpg`),
  ...
  },
  {
    ...
    heroImage: "/projectsImg/my-home-krishe/MHK-img1.jpg",
    gallery: Array.from({ length: 15 }, (_, i) => `/projectsImg/my-home-krishe/MHK-img${i + 1}.jpg`),
  ...
  },
  {
    ...
    gallery: Array.from({ length: 15 }, (_, i) => `/projectsImg/aparna-sarovar/AS-img${i + 1}.jpg`),
  ...
  },
  {
    ...
    heroImage: "/projectsImg/nagole-house/NAG-img1.jpg",
    gallery: Array.from({ length: 15 }, (_, i) => `/projectsImg/nagole/NAG-img${i + 1}.jpg`),
  ...
  },
  {
    ...
    heroImage: "/projectsImg/luxury-villa/Villa-img1.jpg",
    gallery: Array.from({ length: 15 }, (_, i) => `/projectsImg/villa/Villa-img${i + 1}.jpg`),
    location: "Hyderabad",
  ...
  },
  {
    ...
    gallery: Array.from({ length: 15 }, (_, i) => `/projectsImg/forest-edge/FE-img${i + 1}.jpg`),
    location: "Hyderabad",
    houseType: "Luxury Villa",
    year: "2025",
    bg: "#F4EDDB",
