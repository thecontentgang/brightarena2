...
const services = [
  {
    ...
    description:
      "Curated, minimalist living spaces tailored to your daily rhythms.",
    image:
  ...
  },
  {
    ...
    description:
      "Photorealistic rendering and precise spatial planning.",
    image:
  ...
  },
  {
    ...
    description:
      "High-end retail and office environments.",
    image:
  ...
  },
  {
    ...
    description:
      "Custom-crafted architectural furniture pieces.",
    image:
                        ...
                        <div key={service.id} className="w-[100vw] flex items-center justify-center px-4 md:px-12">
                            ...
                            <div className="relative w-full max-w-[1000px] h-[55vh] md:h-[60vh] bg-[#4a1c13] rounded-3xl overflow-hidden group">
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
                                    ...
                                    <button 
                                        className="w-fit h-fit bg-white text-[#4a1c13] px-6 py-3 rounded-full text-xs font-bold tracking-widest uppercase transition-colors hover:bg-[#ff7043] hover:text-white"
