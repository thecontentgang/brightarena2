...
const MinimalHero: React.FC = () => {
  ...
  // --- Mobile detection for video height ---
  ...
  // Mobile: start at 90vh so the bottom card is immediately visible
  const videoHeight = useTransform(
    smoothProgress,
    [0, 0.33],
    isMobile ? ["90vh", "60vh"] : ["100vh", "60vh"]
  );
